...
export function AccessibilityProvider({ children }: AccessibilityProviderProps) {
  ...
  const [fontSize, setFontSizeState] = useLocalStorage<FontSize>('accessibility_font_size', 'medium');
  const [colorScheme, setColorSchemeState] = useLocalStorage<ColorScheme>('accessibility_color_scheme', 'system');
  const [isHighContrast, setIsHighContrastState] = useLocalStorage<boolean>('accessibility_high_contrast', false);
  const [isReducedMotion, setIsReducedMotionState] = useLocalStorage<boolean>('accessibility_reduced_motion', false);
  const [enableVoiceCommands, setEnableVoiceCommandsState] = useLocalStorage<boolean>('accessibility_voice_commands', false);
